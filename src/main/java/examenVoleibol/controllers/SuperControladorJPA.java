package examenVoleibol.controllers;
...
import examenVoleibol.model.Entidad;
...
public class SuperControladorJPA {
	...
	protected EntityManager getEntityManager () {
		if (em == null) {
			em = Persistence.createEntityManagerFactory("examenVoleibol")
				.createEntityManager();
		}
		return em;
	}
	 ...
	 * @return
	 */
	public <T extends Entidad> T findById (int idEquipo) {
		try {
			return (T) getEntityManager().find(tipoEntidad, idEquipo);
		}
